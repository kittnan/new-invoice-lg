...
@Component({
  selector: 'app-no-common-print-packing',
  templateUrl: './no-common-print-packing.component.html',
  styleUrls: ['./no-common-print-packing.component.scss']
})
export class NoCommonPrintPackingComponent implements OnInit {
  ...
  async generatePDF() {
    this.$pdf.generatePDF(this.form.invoiceForm.invoice, 'packing', 'user/no-common/print')
  }

...
@Component({
  selector: 'app-sap-print-all',
  templateUrl: './sap-print-all.component.html',
  styleUrls: ['./sap-print-all.component.scss']
})
export class SapPrintAllComponent implements OnInit {

...
@NgModule({
  declarations: [GenerateInvoiceComponent, ViewInvoiceComponent, PrintInvoiceComponent, ViewPackingComponent, ReprintInvoiceComponent, ReprintPackingComponent, ConfigInvoiceComponent, ConfigPackingComponent, ConfigPacking2Component, ReprintAllComponent],
  imports: [
    CommonModule,
    UserRoutingModule,
    MaterialModule,
